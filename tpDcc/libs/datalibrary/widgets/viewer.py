...
from tpDcc.libs.datalibrary.data.views import group
from tpDcc.libs.datalibrary.widgets import listview, treeview
    ...
    def update_items(self):
        ...
        with qt_contexts.block_signals(self.tree_widget()):
            ...
            try:
                ...
                item_views = [factory.ItemsFactory().create_view_from_item(item) for item in items]
                item_views = [item_view for item_view in item_views if item_view is not None]
